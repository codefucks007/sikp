...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-8">
            <?= form_open_multipart('petugas/edit_petugas'); ?>
            <div class="form-group row">
                <label for="nip" class="col-sm-2 col-form-label">NIP</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="nip" name="nip" value="<?= $data['user']['nip']; ?>">
            ...
            <!-- <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="jabatan" name="jabatan" value="<?= $data['user']['jabatan']; ?>">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="role_id" name="role_id" value="<?= $data['user_role']; ?>" readonly>
                </div>
            </div>
